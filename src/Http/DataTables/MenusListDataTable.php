<?php namespace Edutalk\Base\Menu\Http\DataTables;
...
class MenusListDataTable extends AbstractDataTables
{
    ...
    public function headings()
    {
        return [
            'title' => [
                'title' => trans('edutalk-menus::datatables.heading.title'),
                'width' => '25%',
            ],
            'slug' => [
                'title' => trans('edutalk-menus::datatables.heading.slug'),
                'width' => '25%',
            ],
            'status' => [
                'title' => trans('edutalk-menus::datatables.heading.status'),
                'width' => '15%',
            ],
            'created_at' => [
                'title' => trans('edutalk-menus::datatables.heading.created_at'),
                'width' => '15%',
            ],
            'actions' => [
    ...
    protected function fetchDataForAjax()
    {
        return datatable()->of($this->model)
            ...
            ->addColumn('actions', function ($item) {
                ...
                /*Buttons*/
                $editBtn = link_to(route('admin::menus.edit.get', ['id' => $item->id]), trans('edutalk-core::datatables.edit'), ['class' => 'btn btn-sm btn-outline green']);
