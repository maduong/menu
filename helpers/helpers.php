...
if (!function_exists('menus_management')) {
    /**
     * @return \Edutalk\Base\Menu\Support\MenuManagement
     */
    function menus_management()
    {
        return \Edutalk\Base\Menu\Facades\MenuManagementFacade::getFacadeRoot();
    }
}

if (!function_exists('Edutalk_render_menu')) {
    /**
     * @param string $slug
     * @param array $options
     * @return null|string
     */
    function Edutalk_render_menu($slug, array $options = [])
    {
        /**
        ...
        $options = array_merge([
            ...
            'view' => 'edutalk-menus::front._renderer.menu',
        ], $options);
